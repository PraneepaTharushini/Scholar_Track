              ...
              <div className="login-fields">
                ...
                {mode === "register" && (
                  <div className="lf-field">
                    ...
                    <div className={`lf-input-wrap ${focusedField === "confirmPassword" ? "lf-input-wrap--focused" : ""
                    ...
                    {confirmPassword.length > 0 && (
                      <p className={`lf-match-hint ${password === confirmPassword ? "lf-match-hint--ok" : "lf-match-hint--err"
                        }`}>
